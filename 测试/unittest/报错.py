...
class test所有(unittest.TestCase):
    ...
    def test_运行时报错(self):
        对应报错 = {
            ...
            "测试/错误处理/模块无属性.ul": "AttributeError：module '' has no attribute 'a'",
            ...
            "测试/错误处理/重复引用_绝对路径1.ul": "AttributeError：module '' has no attribute 'TypeDef'",
            "测试/错误处理/重复引用_绝对路径2.ul": "AttributeError：module '' has no attribute 'Instance1'",
