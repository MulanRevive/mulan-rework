...
class test语法树(unittest.TestCase):
    ...
    def test_复杂类型注解(self):
        节点 = 生成语法树("a : list [ int ] = 2")
        标注 = 节点.body[0].annotation
        self.assertIsInstance(标注, ast.Subscript)
        self.assertEqual(标注.value.id, "list")
        self.assertEqual(self.取下标标注(标注).id, "int")
        ...
        函数节点 = 节点.body[0]
        参数标注 = 函数节点.args.args[0].annotation
        返回标注 = 函数节点.returns
        self.assertIsInstance(参数标注, ast.Subscript)
        self.assertEqual(参数标注.value.id, "tuple")
        self.assertEqual(self.取下标标注(参数标注).id, "int")
        self.assertIsInstance(返回标注, ast.Subscript)
        self.assertEqual(返回标注.value.id, "int")
        返回参数 = self.取下标标注(返回标注)
...
""")
    ...
    def test_整树比较(self):
        期望值_3_7 = {
            ...
            "指定函数类型.ul": r"Module(body=[FunctionDef(name='hello', args=arguments(args=[arg(arg='p', annotation=Name(id='int', ctx=Load(), lineno=1, col_offset=16), lineno=1, col_offset=12)], vararg=None, kwonlyargs=[], kw_defaults=[], kwarg=None, defaults=[]), body=[Return(value=Name(id='p', ctx=Load(), lineno=2, col_offset=10), lineno=2, col_offset=3)], decorator_list=[], returns=Subscript(value=Name(id='int', ctx=Load(), lineno=1, col_offset=23), slice=Index(value=Tuple(elts=[Name(id='float', ctx=Load(), lineno=1, col_offset=29), Subscript(value=Name(id='list', ctx=Load(), lineno=1, col_offset=36), slice=Index(value=Name(id='str', ctx=Load(), lineno=1, col_offset=43), lineno=1, col_offset=43), ctx=Load(), lineno=1, col_offset=36), Name(id='dict', ctx=Load(), lineno=1, col_offset=50)], ctx=Load(), lineno=1, col_offset=29), lineno=1, col_offset=29), ctx=Load(), lineno=1, col_offset=23), lineno=1, col_offset=1)])",
        ...
        期望值_3_8 = {
            ...
            "指定函数类型.ul": r"Module(body=[FunctionDef(name='hello', args=arguments(posonlyargs=[], args=[arg(arg='p', annotation=Name(id='int', ctx=Load(), lineno=1, col_offset=16), lineno=1, col_offset=12)], vararg=None, kwonlyargs=[], kw_defaults=[], kwarg=None, defaults=[]), body=[Return(value=Name(id='p', ctx=Load(), lineno=2, col_offset=10), lineno=2, col_offset=3)], decorator_list=[], returns=Subscript(value=Name(id='int', ctx=Load(), lineno=1, col_offset=23), slice=Index(value=Tuple(elts=[Name(id='float', ctx=Load(), lineno=1, col_offset=29), Subscript(value=Name(id='list', ctx=Load(), lineno=1, col_offset=36), slice=Index(value=Name(id='str', ctx=Load(), lineno=1, col_offset=43), lineno=1, col_offset=43), ctx=Load(), lineno=1, col_offset=36), Name(id='dict', ctx=Load(), lineno=1, col_offset=50)], ctx=Load(), lineno=1, col_offset=29), lineno=1, col_offset=29), ctx=Load(), lineno=1, col_offset=23), lineno=1, col_offset=1)], type_ignores=[])",
        ...
        期望值_3_9.update(
            {
                ...
                "指定函数类型.ul": r"Module(body=[FunctionDef(name='hello', args=arguments(posonlyargs=[], args=[arg(arg='p', annotation=Name(id='int', ctx=Load(), lineno=1, col_offset=16), lineno=1, col_offset=12)], kwonlyargs=[], kw_defaults=[], defaults=[]), body=[Return(value=Name(id='p', ctx=Load(), lineno=2, col_offset=10), lineno=2, col_offset=3)], decorator_list=[], returns=Subscript(value=Name(id='int', ctx=Load(), lineno=1, col_offset=23), slice=Tuple(elts=[Name(id='float', ctx=Load(), lineno=1, col_offset=29), Subscript(value=Name(id='list', ctx=Load(), lineno=1, col_offset=36), slice=Name(id='str', ctx=Load(), lineno=1, col_offset=43), ctx=Load(), lineno=1, col_offset=36), Name(id='dict', ctx=Load(), lineno=1, col_offset=50)], ctx=Load(), lineno=1, col_offset=29), ctx=Load(), lineno=1, col_offset=23), lineno=1, col_offset=1)], type_ignores=[])",
        ...
        期望值_3_13_3_14.update(
            {
                ...
                "指定函数类型.ul": r"Module(body=[FunctionDef(name='hello', args=arguments(posonlyargs=[], args=[arg(arg='p', annotation=Name(id='int', ctx=Load(), lineno=1, col_offset=16), lineno=1, col_offset=12)], kwonlyargs=[], kw_defaults=[], defaults=[]), body=[Return(value=Name(id='p', ctx=Load(), lineno=2, col_offset=10), lineno=2, col_offset=3)], decorator_list=[], returns=Subscript(value=Name(id='int', ctx=Load(), lineno=1, col_offset=23), slice=Tuple(elts=[Name(id='float', ctx=Load(), lineno=1, col_offset=29), Subscript(value=Name(id='list', ctx=Load(), lineno=1, col_offset=36), slice=Name(id='str', ctx=Load(), lineno=1, col_offset=43), ctx=Load(), lineno=1, col_offset=36), Name(id='dict', ctx=Load(), lineno=1, col_offset=50)], ctx=Load(), lineno=1, col_offset=29), ctx=Load(), lineno=1, col_offset=23), type_params=[], lineno=1, col_offset=1)], type_ignores=[])",
            }
        )
    ...
    def 取下标标注(self, 节点):
        if isinstance(节点.slice, ast.Index):
            return 节点.slice.value
        return 节点.slice
