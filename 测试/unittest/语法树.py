...
class test语法树(unittest.TestCase):
    ...
    def test_整树比较(self):
        ...
        期望值 = {
            ...
            "超类语法.ul": "Module(body=[ClassDef(name='Animal', bases=[], keywords=[], body=[], decorator_list=[], lineno=1, col_offset=1), ClassDef(name='Person', bases=[Name(id='Animal', ctx=Load(), lineno=2, col_offset=15)], keywords=[], body=[FunctionDef(name='__init__', args=arguments(args=[arg(arg='self', annotation=None, lineno=3, col_offset=3)], vararg=None, kwonlyargs=[], kw_defaults=[], kwarg=None, defaults=[]), body=[Expr(value=Call(func=Attribute(value=Call(func=Name(id='super', ctx=Load(), lineno=4, col_offset=5), args=[], keywords=[], lineno=4, col_offset=5), attr='__init__', ctx=Load(), lineno=4, col_offset=5), args=[], keywords=[], lineno=4, col_offset=5), lineno=4, col_offset=5)], decorator_list=[], lineno=3, col_offset=3)], decorator_list=[], lineno=2, col_offset=1), Assign(targets=[Name(id='p', ctx=Store(), lineno=7, col_offset=1)], value=Call(func=Name(id='Person', ctx=Load(), lineno=7, col_offset=5), args=[], keywords=[], lineno=7, col_offset=5), lineno=7, col_offset=1), Assign(targets=[Name(id='v', ctx=Store(), lineno=8, col_offset=1)], value=Call(func=Attribute(value=Name(id='p', ctx=Load(), lineno=8, col_offset=5), attr='super', ctx=Load(), lineno=8, col_offset=5), args=[], keywords=[], lineno=8, col_offset=7), lineno=8, col_offset=1), Expr(value=Call(func=Attribute(value=Name(id='Person', ctx=Load(), lineno=9, col_offset=1), attr='super', ctx=Load(), lineno=9, col_offset=1), args=[Name(id='None', ctx=Load(), lineno=9, col_offset=14)], keywords=[], lineno=9, col_offset=8), lineno=9, col_offset=8)])",
        }
        for 文件 in 期望值:
            源码路径 = 路径 + 文件
            节点 = 读源码生成树(源码路径)
