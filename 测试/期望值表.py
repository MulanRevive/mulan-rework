...
期望值 = {
    ...
    "函数/map.ul": b"[1, 4, 9]",
    "函数/返回多值.ul": b"12",
    "函数/匿名函数.ul": b"[1][1][3][3][1, 4]12true34[1]2460666",
    ...
    "函数/变长参数.ul": b"intfloatstrTest1 2 3str3714haha",
    ...
    "数据结构/字典.ul": b"0acfalsefalse1a1b21{1: a}{1: ['a', 'b']}",
    "数据结构/集合.ul": b"{1, 2, 3}{a}",
    "数据结构/多项.ul": b"1, 2, 31, 2",
    "数据结构/枚举.ul": b"12",
    "数据结构/标识符.ul": b"36",
